    ...
    function k(p, v) {
        ...
        function j(e, n) {
            ...
            n && w.currentYear !== a && (De("onYearChange"),
                    q()), !n || w.currentYear === a && w.currentMonth === i || De("onMonthChange"),
                w.redraw()
        }
        ...
        function R(e, n, t, a) {
            ...
            return o.dateObj = n,
                o.$i = a,
                o.setAttribute("aria-label", w.formatDate(n, w.config.ariaDateFormat)), -1 === e.indexOf("hidden") && 0 === M(n, w.now) && (w.todayDateElem = o,
        ...
        w.parseDate = C({
            ...
            w.clear = function(e, n) {
                ...
                w.selectedDates = [],
                    w.latestSelectedDateObj = void 0, !0 === n && (w.currentYear = w._initialDate.getFullYear(),
        ...
        function ye(e) {
            void 0 === e && (e = !0),
                ...
                void 0 !== w.altInput && (w.altInput.value = Me(w.config.altFormat)), !1 !== e && De("onValueUpdate")
        }
                    ...
                    function() {
                        ...
                        w.input._type = w.input.type,
                            ...
                            w.config.altInput && (w.altInput = d(w.input.nodeName, w.config.altInputClass),
                                ...
                                w.input.setAttribute("type", "hidden"), !w.config.static && w.input.parentNode && w.input.parentNode.insertBefore(w.altInput, w.input.nextSibling));
